...
const styles = StyleSheet.create({
  ...
  screen: { flex: 1 },
  arcadeHeader: { height: 68, backgroundColor: '#070d0f', borderBottomWidth: 3, shadowColor: colors.cyan, shadowOpacity: 0.45, shadowRadius: 0, shadowOffset: { width: 0, height: 3 }, elevation: 7 },
