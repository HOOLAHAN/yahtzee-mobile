...
const styles = StyleSheet.create({
  ...
  modalBackdrop: { flex: 1, backgroundColor: 'rgba(0,0,0,.72)', justifyContent: 'flex-end' }, modalDismiss: { flex: 1 }, detailSheet: { maxHeight: '88%', backgroundColor: colors.surface, borderTopColor: colors.cyan, borderTopWidth: 1, borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingTop: 16, paddingHorizontal: 16, paddingBottom: 16 }, detailHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, detailContent: { paddingBottom: 16 }, detailEyebrow: { color: colors.pink, fontSize: 9, fontWeight: '900', letterSpacing: 1.2, textTransform: 'uppercase' }, detailTitle: { color: colors.white, fontSize: 19, fontWeight: '900', marginTop: 1 }, close: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#263337', alignItems: 'center', justifyContent: 'center' }, scoreHero: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'space-between', marginTop: 5 }, detailScore: { color: colors.yellow, fontSize: 43, lineHeight: 50, fontWeight: '900' }, detailDate: { color: colors.muted, fontSize: 9 }, detailCopy: { flex: 1, color: colors.mint, fontSize: 11, lineHeight: 17, marginTop: 0 }, metrics: { flexDirection: 'row', gap: 5, marginTop: 7 }, metric: { flex: 1, minHeight: 57, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.background, borderRadius: 9 }, metricValue: { color: colors.cyan, fontSize: 18, fontWeight: '900' }, metricLabel: { color: colors.muted, fontSize: 7.5, fontWeight: '800', marginTop: 2, textAlign: 'center' }, legacyNotice: { flexDirection: 'row', alignItems: 'flex-start', gap: 9, marginTop: 10, padding: 12, borderRadius: 11, backgroundColor: colors.background },
});
