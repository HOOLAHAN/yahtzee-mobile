    ...
    <ScrollView contentContainerStyle={styles.content} refreshControl={<RefreshControl refreshing={loading} onRefresh={() => { setLoading(true); void load(); }} tintColor={colors.cyan} />}>
      ...
      <View style={styles.controlPanel}>
        <View style={styles.selectRow}>
          ...
          <Pressable onPress={() => setFilterMenu('period')} style={styles.selectControl}><Text style={styles.selectLabel}>TIME PERIOD</Text><View style={styles.selectValueRow}><Text numberOfLines={1} style={styles.selectValue}>{timePeriodLabel}</Text><Ionicons name="chevron-down" size={15} color={colors.cyan} /></View></Pressable>
        </View>
