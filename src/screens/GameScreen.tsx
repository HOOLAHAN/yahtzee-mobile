    ...
    <ScrollView contentContainerStyle={[styles.content, selectedCategory && styles.contentWithLock]}>
      {complete ? <View style={styles.completeCard}>
        ...
        <View style={styles.actions}>
          ...
          <Pressable accessibilityRole="button" accessibilityLabel="Reset game" onPress={reset} style={styles.gameActionButton}><Ionicons name="refresh-outline" size={18} color={colors.muted} /><Text style={[styles.gameActionText, styles.resetText]}>Reset</Text></Pressable>
        </View>
      </>}
    </ScrollView>
