  ...
  return <View style={styles.gameContainer}>
    ...
    <ScrollView contentContainerStyle={[styles.content, selectedCategory && styles.contentWithLock]}>
      {complete ? <View style={styles.completeCard}>
        ...
        <View style={styles.actions}><Pressable accessibilityRole="button" accessibilityLabel="Reset game" onPress={reset} hitSlop={10} style={styles.resetButton}><Ionicons name="refresh-outline" size={14} color={colors.muted} /><Text style={styles.resetText}>Reset</Text></Pressable></View>
      </>}
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  turnHeadingRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 9 }, title: { color: colors.yellow, fontSize: 21, fontWeight: '900' }, playerTwo: { color: colors.pink }, progress: { color: colors.muted, fontSize: 12, marginTop: 1 }, scorecardButton: { flexDirection: 'row', alignItems: 'center', gap: 5, borderColor: '#315a5e', borderWidth: 1, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 7 }, scorecardButtonText: { color: colors.cyan, fontWeight: '800', fontSize: 12 },
  ...
  actions: { flexDirection: 'row', justifyContent: 'flex-end', marginTop: 7 }, resetButton: { flexDirection: 'row', gap: 4, paddingHorizontal: 4, paddingVertical: 3, alignItems: 'center' }, resetText: { color: colors.muted, fontSize: 11, fontWeight: '700' },
