  ...
  return <View style={styles.gameContainer}>
    ...
    <Modal transparent animationType="slide" visible={showScorecard} onRequestClose={() => setShowScorecard(false)}>
      <View style={styles.sheetBackdrop}><Pressable accessibilityLabel="Close scorecard" style={styles.sheetDismissArea} onPress={() => setShowScorecard(false)} /><SafeAreaView style={styles.sheet}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentInsetAdjustmentBehavior="automatic" contentContainerStyle={styles.sheetContent}>{scorecardContent(viewingPlayer)}</ScrollView>
      </SafeAreaView></View>
    </Modal>
  </View>;
}
...
const styles = StyleSheet.create({
  ...
  sheetBackdrop: { flex: 1, backgroundColor: 'rgba(0,0,0,0.68)', justifyContent: 'flex-end' }, sheetDismissArea: { flex: 1 }, sheet: { height: '88%', backgroundColor: colors.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24, borderColor: '#315a5e', borderWidth: 1, paddingTop: 8, overflow: 'hidden' }, sheetHandle: { width: 42, height: 4, borderRadius: 2, backgroundColor: '#45565a', alignSelf: 'center' }, sheetHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingTop: 12, paddingBottom: 10 }, sheetTitle: { color: colors.yellow, fontSize: 24, fontWeight: '900' }, sheetSubtitle: { color: colors.muted, fontSize: 11, marginTop: 2 }, sheetClose: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#263337', alignItems: 'center', justifyContent: 'center' }, sheetContent: { paddingHorizontal: 20, paddingBottom: 54 }, scorecardTabs: { flexDirection: 'row', marginHorizontal: 20, marginBottom: 10, backgroundColor: colors.background, borderRadius: 10, padding: 3 }, scorecardTab: { flex: 1, alignItems: 'center', padding: 9, borderRadius: 8 }, scorecardTabActive: { backgroundColor: '#20383b' }, scorecardOverview: { flexDirection: 'row', backgroundColor: colors.background, borderRadius: 13, borderColor: '#26383c', borderWidth: 1, paddingVertical: 12 }, overviewItem: { flex: 1, alignItems: 'center' }, overviewDivider: { width: 1, backgroundColor: '#2d3c40' }, overviewLabel: { color: colors.muted, fontSize: 10, fontWeight: '800', textTransform: 'uppercase' }, overviewValue: { color: colors.mint, fontSize: 16, fontWeight: '900', marginTop: 3 }, overviewTotal: { color: colors.yellow, fontSize: 20, fontWeight: '900', marginTop: 1 }, bonusRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 8, paddingVertical: 9, paddingHorizontal: 10, borderRadius: 9, backgroundColor: colors.background }, bonusRowEarned: { backgroundColor: '#163033' }, bonusCopy: { flexDirection: 'row', alignItems: 'center', gap: 6 }, bonusLabel: { color: colors.muted, fontSize: 12 }, bonusValue: { color: colors.muted, fontSize: 12, fontWeight: '800' }, bonusEarned: { color: colors.cyan }, scoreGroupTitle: { color: colors.pink, fontWeight: '900', fontSize: 17, marginTop: 14, marginBottom: 3 }, sheetScoreRow: { flexDirection: 'row', justifyContent: 'space-between', borderBottomColor: '#2a3639', borderBottomWidth: 1, paddingVertical: 8 }, sheetCategory: { color: colors.mint }, sheetScore: { color: colors.yellow, fontWeight: '900' }, sheetTotalRow: { flexDirection: 'row', justifyContent: 'space-between', borderTopColor: colors.cyan, borderTopWidth: 1, marginTop: 16, paddingTop: 14, paddingBottom: 8 }, sheetTotalLabel: { color: colors.cyan, fontSize: 18, fontWeight: '900' }, sheetTotal: { color: colors.yellow, fontSize: 24, fontWeight: '900' },
});
