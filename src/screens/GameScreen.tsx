...
interface GameScreenProps { chooserRequest?: number; dailyLaunchRequest?: number; onHeaderTitleChange?: (title: string) => void; scoreSuggestionsEnabled?: boolean; remindersEnabled?: boolean; onRequestReminders?: () => void; onDailyCompleted?: () => void; onOpenAccount?: (createAccount?: boolean) => void }
