...
export function AboutScreen() {
  return <ScrollView contentContainerStyle={styles.content}>
    ...
    <View style={styles.accountCard}><Ionicons name="shield-checkmark-outline" size={24} color={colors.cyan} /><Text style={styles.accountCopy}>Sign in with the same secure Cognito account used by the website. Public leaderboard scores can be viewed by everyone, while submitting a score requires authentication. Your account controls include password changes, sign out and account deletion.</Text></View>
