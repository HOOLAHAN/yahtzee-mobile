...
export function VirtualDiceScreen() {
...
const styles = StyleSheet.create({
  ...
  rollButton: { width: '100%', minHeight: 54, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 20, borderRadius: 14, backgroundColor: colors.cyan, shadowColor: colors.cyan, shadowOpacity: 0.3, shadowRadius: 10, elevation: 6 }, rollText: { color: colors.background, fontSize: 17, fontWeight: '900' }, pressed: { opacity: 0.78, transform: [{ scale: 0.98 }] },
});
