...
const appScheme = (Array.isArray(configuredScheme) ? configuredScheme[0] : configuredScheme) || 'yahtzee';
const appInviteUrl = (code: string) => `${appScheme}://play?join=${code}`;
